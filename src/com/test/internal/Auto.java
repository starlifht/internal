...
public static void justdoit() throws Exception{
	...
	if(APITools.errorInfo.length()!=0&&APITools.errorInfo!=null){
		try{
		SendCloud.sendMail("154985201@qq.com", "PassPort监控报警", APITools.errorInfo.toString());
		SendCloud.sendMail("446204722@qq.com", "PassPort监控报警", APITools.errorInfo.toString());
		}
		catch(Exception e){
			Mobile.sendSms("18810606513", 
					" PassPort Monitor ERROR!"+e.toString());
